...
import com.example.lynnyuki.cloudfunny.contract.ImageContract;
import com.example.lynnyuki.cloudfunny.model.http.ImageApi;
        ...
        addSubscribe(imageApi.download(url)
                ...
                .subscribeWith(new BaseSubscriber<ResponseBody>(context, mView) {
                    ...
                    public void onNext(ResponseBody responseBody) {
                        ...
                        File parentFile = AppFileUtil.createFileDir(context, "CloudFunny");
